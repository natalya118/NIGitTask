...
$("#add-to-cart-button").click(function(){
    checkQuantity();
    i += addByStep;
    totalPrice += (parseFloat($("#price").text())*addByStep);
    ...
    $("#main-image").hover(function () {
        $("#main-image").attr("src",src="https://store.arduino.cc/bmz_cache/4/4781bf9734157511eb40f2edcb3dc38a.image.538x354.jpg" );
    },
                           function(){
        $("#main-image").attr("src",src="https://store.arduino.cc/bmz_cache/2/29876275dc7dcdcfd01caa5dc48442d7.image.446x354.jpg" );
    });

    
    
    $("#countryChoise").change(function() {
        console.log("ololo");
        var x = $("#countryChoise").val();
        var arr = $(".short-name");
        if (x=="Ukraine"){
                for (var i = 0; i < 9; i++){
                    if (i%2==0){
                        arr[i].innerHTML="Shipping to Ukraine";
                    } 
                }
            }else{
                for (var i = 0; i < 9; i++){
...
function checkQuantity(){
        if (i>4)
            alert("It's never too many Arduinos ;)");
    }


function changeQuantity() {
    addByStep = +document.getElementById("Option").value;
